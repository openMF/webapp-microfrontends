...
export namespace LoanProductRelatedDetail {
    ...
    export type LoanScheduleProcessingTypeEnum = 'HORIZONTAL' | 'VERTICAL';
    export const LoanScheduleProcessingTypeEnum = {
        Horizontal: 'HORIZONTAL' as LoanScheduleProcessingTypeEnum,
        Vertical: 'VERTICAL' as LoanScheduleProcessingTypeEnum
    };
    export type LoanScheduleTypeEnum = 'CUMULATIVE' | 'PROGRESSIVE';
    export const LoanScheduleTypeEnum = {
        Cumulative: 'CUMULATIVE' as LoanScheduleTypeEnum,
        Progressive: 'PROGRESSIVE' as LoanScheduleTypeEnum
    };
